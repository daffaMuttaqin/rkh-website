            ...
            <div class="my-10 lg:mt-20">
                ...
                <div class="flex justify-between">
                    ...
                    <div>
                        ...
                        <!-- TOMBOL DAPAT POINT -->
                        <button data-modal-target="modal-dapatkan-diskon" data-modal-toggle="modal-dapatkan-diskon" type="button" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">Dapatkan Diskon</button>
                    </div>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="<?= base_url('admin/dapatkan_diskon'); ?>" method="post">
                        ...
                        <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Dapatkan</button>
                    </form>
                </div>
            </div>
        </div>
                    ...
                    <form class="space-y-6" action="<?= base_url('admin/tambah_aksi_semua_produk'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <!-- <div>
                            <label for="favorite" class="inline-flex relative items-center cursor-pointer">
                                <input type="checkbox" value="0" id="favorite" name="favorite" class="sr-only peer">
