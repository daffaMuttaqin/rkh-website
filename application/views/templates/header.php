...
<body x-data="{navbarOpen: false, scrolledFromTop: false}" @scroll.window="window.pageYOffset > 60 ? scrolledFromTop = true : scrolledFromTop = false" x-init="window.pageYOffset > 60 ? scrolledFromTop = true : scrolledFromTop = false" class="absolute">
    <!-- menu -->
    <header class="bg-amber-800 fixed z-50 w-full flex justify-between items-center px-4 md:px-12 h-24 transition-all duration-300" :class="{'h-24': !scrolledFromTop, 'h-12': scrolledFromTop}">
        <a href="#">
...
";
            ...
            <div class="h-full w-full">
                ...
                <a href="#up" class="fixed hidden z-50 lg:bottom-0 bottom-20 lg:right-24 right-0 lg:mr-8 lg:mb-8 mr-4 mb-4 hover:scale-110 transition-all duration-300" :class="{'hidden': !scrolledFromTop, 'block': scrolledFromTop}">
